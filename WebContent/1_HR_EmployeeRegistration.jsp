   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="grpelem" id="u3128" style="text-align: center"><!-- custom html -->
        <form action="HR_AddEmployee" method= "post" style="float:center" onsubmit="return validate(this);">
              ...
              <input class="formtext" name="fname" placeholder= "First Name" type="text">
              <br><br>
              <input class="formtext" name="lname" placeholder= "lastname" type="text">
              <br><br>
            ...
            <br><br>
              <input class="formtext" name="email" placeholder= "Email Address" type="email">
              <br><br>
            <input class="formtext" name="mobilenum" placeholder= "Mobile Number" type="text">
            <br><br>
            ...
            <br><br>
            <input class="formtext" name="password1" placeholder="Password" type="password">
            <br><br>
            <input class="formtext" name="password" placeholder="Confirm Password" type="password">
