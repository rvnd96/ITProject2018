  ...
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu133"><!-- group -->
    ...
    <div class="clearfix" id="u1054-6"><!-- content -->
     <p id="u1054-2">Roshan Gunananda</p>
     <p id="u1054-4">Inventory Manager</p>
    </div>
   </div>
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <div class="clearfix grpelem" id="u1155-14"><!-- content -->
     <p id="u1155-2">Roshan Gunanada</p>
     <p id="u1155-4">645125794V</p>
     <p id="u1155-6">inventorycemgr@bluetown.com</p>
     <p id="u1155-8">0774311631</p>
     <p id="u1155-10">54/4, Colombo Road, Gampaha.</p>
    ...
    <a href="4_IL_raw_material_table.jsp"><button id="u1170"><p class="button-text">Raw Material</p></button></a>
    <a href="4_IL_equipment_table.jsp"><button id="u1161"><p class="button-text">Construction tools</p></button></a>
    <a href="4_IL_asset-information-portal.jsp"><button id="u1167"><p class="button-text">Logistics</p></button></a>
    <a href="4_IL_purchase-entry.jsp"><button id="u1164"><p class="button-text">Monthly Report</p></button></a>
