...
<div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="pu1447"><!-- group -->
        ...
        <div class="grpelem" id="invent1"><!-- custom html -->
            <style type="text/css">
                .tg  {margin-left: -30px; border-collapse:collapse;border-spacing:0;border-color:transparent;}
				...
				<table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="2_finance_purchase-entry.jsp"><button>Add New Record</button></a>
						</td>
					</tr>
				</table>
				<br><br>
