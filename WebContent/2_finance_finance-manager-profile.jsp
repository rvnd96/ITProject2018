 ...
 <body>
  <div class="museBGSize clearfix borderbox" id="page"><!-- group -->
   ...
   <div class="clearfix grpelem" id="pu1447"><!-- group -->
    ...
    <a href="bill-information-portal.jsp"><button id="u1170"><p class="button-text">Utility Bills</p></button></a>
    <a href="revenue-information-portal.jsp"><button id="u1161"><p class="button-text">Monthly Revenues</p></button></a>
    <a href="asset-information-portal.jsp"><button id="u1167"><p class="button-text">Assets</p></button></a>
    <a href="purchase-information-portal.jsp"><button id="u1164"><p class="button-text">Purchases</p></button></a>
