          ...
          <table>
					<tr>
						...
						<td  style="padding: 10px">
							<a href="salary-form.jsp"><button>Add New Record</button></a>
						</td>
...
if(query !=null){
	...
	sql = "select e.nic, s.nic, e.fname, e.lname, s.basicSal, s.bonus, s.decrement, s.otrate, s.othrs, s.commission,s.total from blueLite.salary s inner join blueLite.employee e on e.nic = s.nic  where s.nic like '%"+query+"%'";
	
	 
}else{
	
sql ="select e.nic, s.nic, e.fname, e.lname, s.basicSal, s.bonus, s.decrement, s.otrate, s.othrs, s.commission,s.total from blueLite.salary s inner join blueLite.employee e on e.nic = s.nic";
